...
set p4client           = udeAutoPCS_guttman_us01 
set p4_root            = `realpath ~/${p4ws}`
set project_family     = "ddr5"
set macro              = "dwc_ddr5phy_txrxdq_ew"
set project            = "d921-ddr5-int18a-12"
set product            = "lpddr5x_ddr5_phy"
set release            = "rel1.00_cktpcs"
set release_ver        = "1.10a"
set proj_spec          = "${project_family}/${project}/${release}"
set p4_path            = "wwcad/msip/products/${product}/${project_family}/project/${project}/ckt/rel/"
set p4_view_dir        = ""
set p4_disk_dir        = "${p4_root}/${p4_path}/${macro}"
...
#set script             = alphaHLDepotSeed
set script             = ${exe_dir}/alphaHLDepotSeed
set script_options     = "-p4ws ${p4ws} -macros ${macro} -p ${proj_spec}"
set run_prefix         = ""
#Location of run:  /slowfs/us01dwt2p373/guttman/p4_ws/wwcad/msip/products/ddr43_lpddr4_v2/project/d547-lpddr4mv2-umc28hpcp18/ckt/rel
...
#        echo "    ${p4_view_dir}/... //msip_cd_ljames/depot/${p4_path}/${macro}/${release_ver}/..."
#    endif
...
echo $run_prefix $script $script_options $test_options
