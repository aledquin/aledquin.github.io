...
set macro              = "dwc_ddr5phy_utility_cells"
set project            = "d910-ddr5-tsmc5ff-12"
...
set run_prefix         = ""
#Location of run: /slowfs/us01dwt2p373/guttman/p4_ws/wwcad/msip/products/lpddr5x_ddr5_phy/ddr5/project/d910-ddr5-tsmc5ff-12/ckt/rel
...
set echo
grep "missing in" ${p4_root}/depot/products/${project_family}/project/${project}/ckt/rel/${macro}/${release_ver}/macro/${macro}.pincheck
unset echo
