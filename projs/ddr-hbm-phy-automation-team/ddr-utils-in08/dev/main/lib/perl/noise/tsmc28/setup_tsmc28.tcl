...
##    rowVar:  The parameter against which cap values are normalized.  Typically W (device width), WIDTH (similar), AD (diffusion area), etc..
##
...
proc charMos {device type PVT supply w l diffA diffP} {
    ...
    set_device_params $device {l=L w=W  nf=1 multi=1 ccosflag=0 ccodflag=0 rgflag=1 rcosflag=1 rcodflag=1 ad=AD as=AS pd=PD ps=PS}
    set vSupply [supplyVoltage $PVT $supply]
    ...
    genTables Cg $device $PVT $supply {OFFSET L} W
    ...
    set_measurement_node D
    set_param [list OFFSET [list 0 $vSupply]] [list W $w] [list L $l] {PS 0} {AS 0} {PD 0} {AD 0}
    genTables Csd $device $PVT $supply {OFFSET L} W

    ##  Diff area (ad) sims
    reset_sim
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node D
    set_param [list OFFSET [list 0 $vSupply]] [list W $oneW] [list L $oneL] {PS 0} {AS 0} {PD 0} [list AD $diffA]
    ...
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node D
    set_param [list OFFSET [list 0 $vSupply]] [list W $oneW] [list L $oneL] {PS 0} {AS 0} {AD 0} [list PD $diffP]
    ...
    set_param [list OFFSET [list 0 $vSupply]] [list W $oneW] [list L $oneL] {PS 0} {AD 0} {PD 0} [list AS $diffA]
    ...
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node S
    set_param [list OFFSET [list 0 $vSupply]] [list W $oneW] [list L $oneL] {PD 0} {AS 0} {AD 0} [list PS $diffP]
