...
proc charRes3t {device PVT supply w l} {
    ...
    set_device_params $device {l=L w=W m=1 pbar=1 sbar=1 orientation=2 ncr=2}
    set vSupply [supplyVoltage $PVT $supply]

    ##  R sims
    reset_sim
    set_node_supply [list T1 0] [list B 0]
    set_measurement_node T2
    set_param [list W $w] [list L $l]
...
proc charMos {device type PVT supply nfin l diffA diffP} {
    ...
    # set_device_node_caps $device {G Cg} {D {Csd Cad Cpd}} {S {Csd Cas Cps}} {B}        DATE 10/16       
    set_device_params $device {l=L nfin=NFIN  nf=1 multi=1 ccosflag=0 ccodflag=0 rgflag=1 rcosflag=1 rcodflag=1 adej=ADEJ asej=ASEJ pdej=PDEJ psej=PSEJ}
    #set_device_params $device {l=L nfin=NFIN  nf=1 multi=1 ccosflag=0 ccodflag=0 rgflag=1 rcosflag=1 rcodflag=1 ad=AD as=AS pd=PD ps=PS}   DATE 10/16
    set vSupply [supplyVoltage $PVT $supply]
    ...
    set_param [list NFIN $nfin] [list L $l] {PSEJ 0} {ASEJ 0} {PDEJ 0} {ADEJ 0}
    ...
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $nfin] [list L $l] {PSEJ 0} {ASEJ 0} {PDEJ 0} {ADEJ 0}
    ...
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node D
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $oneNfin] [list L $oneL] {PSEJ 0} {ASEJ 0} {PDEJ 0} [list ADEJ $diffA]
    genTables Cad $device $PVT $supply {OFFSET} ADEJ

    ##  Diff periphery (pd) sims
    reset_sim
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node D3
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $oneNfin] [list L $oneL] {PSEJ 0} {ASEJ 0} {ADJ 0} [list PDEJ $diffP]
    genTables Cpd $device $PVT $supply {OFFSET} PDEJ

    ##  Diff area (as) sims
    reset_sim
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node S
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $oneNfin] [list L $oneL] {PSEJ 0} {ADEJ 0} {PDEJ 0} [list ASEJ $diffA]
    genTables Cas $device $PVT $supply {OFFSET} ASEJ

    ##  Diff periphery (ps) sims
    reset_sim
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node S
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $oneNfin] [list L $oneL] {PDEJ 0} {ASEJ 0} {ADEJ 0} [list PSEJ $diffP]
    genTables Cps $device $PVT $supply {OFFSET} PSEJ
...
proc charPode {device type PVT supply nfin l diffA diffP} {
    ...
    set_device_params $device {l=L nfin=NFIN  nf=1 multi=1 ccosflag=0 ccodflag=0 rgflag=1 rcosflag=1 rcodflag=1 pdej=PDEJ psej=PSEJ}
    set vSupply [supplyVoltage $PVT $supply]
    ...
    set_measurement_node G
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $nfin] [list L $l] {PSEJ 0} {ASEJ 0}
    genTables Cg $device $PVT $supply {OFFSET L} NFIN
    ...
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node S
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $oneNfin] [list L $oneL] {PSEJ 0} [list ASEJ $diffA]
    genTables Cas $device $PVT $supply {OFFSET} ASEJ
    ...
    set_node_supply [list S $VS] [list G $VS] [list B $VS] 
    set_measurement_node S
    set_param [list OFFSET [list 0 $vSupply]] [list NFIN $oneNfin] [list L $oneL] {ASEJ 0} [list PSEJ $diffP]
    genTables Cps $device $PVT $supply {OFFSET} PSEJ
