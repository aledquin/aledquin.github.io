...
proc Main {} {
    ...
    foreach instance $instance_list {
        ...
        for {set x 0} {$x < [array size ptransistor]} {incr x} {
            set jobsList ""
            cd  /slowfs/us01dwt2p313/srisowm/lpddr4xm/d549-lpddr4xm-tsmc7ff18/rel1.50/design/timing/nt/pocv/timing/Run_ffg0p715v0c_etm/xtor_variations/ffg0p715v0c_NOR_2_pch_18ud12_mac_nch_18ud12_mac_0.072_0.715v
            set i 0
            ...
            if { [file exists ./$__coeff_file] }  {
                ...
                puts " ERROR : __coeff_file : $__coeff_file ;  nt_${instance}_$ptransistor($x)_$ntransistor($x)_$lengthtransistor($x)_$__vdd_voltage$a  NOT created  UFFFFFFFFFFFFFFFF  :( ) \n "
            }
