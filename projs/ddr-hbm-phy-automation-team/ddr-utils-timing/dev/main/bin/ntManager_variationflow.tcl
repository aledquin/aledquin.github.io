...
#    logMsg "Info: Creating POCV var coeff file $pvt \n"
	...
	if [info exists ::hspiceVersion]   {set cmd [add2CommandLog $cmd "HSPICEversion=$::hspiceVersion"]}
...
proc setupRundirs {} {
	...
	foreach pvt $::pvtCorners {
		...
		if [file exists $::scriptDir/nt_gen_pocv_variation_num_coeff.tcl ] {
		    createSimpleLink $dir/nt_gen_pocv_variation_num_coeff.tcl  $::scriptDir/nt_gen_pocv_variation_num_coeff.tcl 
		} else {
