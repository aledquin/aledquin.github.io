#Vivek: Updated PBSA derates to align with design council mandates(10/25/2018)
# Mantis : 35106
...
utils__script_usage_statistics $script_name "2022ww33"
...
append link_vdd_alias " vdd vddp VDD VDDP vp VMEMP VMEMIO VDDQ VDA VDS3 VDDQLP VAA BP_VREFDACREF_IN VDD2 VDD2H VDDQ_VDD2H VDDQL"
...
set timing_pocv_sigma_min 5

### JIRA - https://jira.internal.synopsys.com/browse/P10023532-41438
set model_enable_split_early_late_sigma false

### For slew based MPW arcs (aligned with ckt/DI leads - JIRA P80001562-184908)
set_app_var model_enable_tabular_self_referential_constraints true
