...
lappend ::dbInfo {Tcl 8.7a4 unix, Tk 8.7a4 x11}
set ::dbTclVersion 8.7
set ::knownGlobals {argc argv argv0 auto_index auto_path env errorCode errorInfo map tcl_interactive tcl_library tcl_nonwordchars tcl_patchLevel tcl_pkgPath tcl_platform tcl_rcFileName tcl_version tcl_wordchars test tk_library tk_patchLevel tk_strictMotif tk_version}
set ::knownCommands {
.
::tcltest::verbose
get_max_val
...
after
all_outputs
alpha::tag::getErrorCode
alpha::tag::syncTagHierarchy
alpha::tag::tagHierarchy
alpha::tag::verifyProceed
append
apply
array
auto_execok
...
gi::closeWindows
gi::createAction
gi::createBooleanInput
gi::createCheckableGroup
gi::createColumn
gi::createDialog
gi::createFileInput
gi::createGroup
...
set ::subCmd(_obj,ttk::treeview) {bbox cget children column configure delete detach drag drop exists focus heading identify index insert instate item move next parent prev see selection set state style tag xview yview}
...
set ::subCmd(tk) {appname busy caret fontchooser inactive scaling sysnotify systray useinputmethods windowingsystem}
