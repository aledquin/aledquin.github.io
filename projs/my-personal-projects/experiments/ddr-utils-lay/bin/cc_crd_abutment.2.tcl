...
namespace eval cc_crd_abutment {
    ...
    proc CRDTestcaseCreationExecProc {dialog} {
        ...
        foreach testcase $testcases {
            ...
            add_boundary_layer $design [list $leftHalo $bottomHalo $rightHalo $topHalo]
            de::save $context
            de::close $context
        }
    }
    ...
    proc launchCRDTestcaseCreation {} {
        ...
        set reflibsInput [gi::createListInput reflibsInput -parent $crdDialog -label "Reference Libraries" -header "Available Selected" -items $libs -selectionModel multiple -viewType dualList -showFilter]
