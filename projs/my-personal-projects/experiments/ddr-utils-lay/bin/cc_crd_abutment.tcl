...
namespace eval cc_crd_abutment {
  ...
  variable floorplan_default_file "crd_abutment_floorplans.tcl"

  proc invoke_floorplan {scriptDir {floorplan_file $floorplan_default_file}} {
    variable $scriptDir
